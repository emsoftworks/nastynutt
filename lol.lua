...
gui.signin_load.Text = "load nigga!"
...
gui.blazedLoader:Destroy()
        ...
        if getgenv().NotiMode == "Roblox" then
            ...
            if getgenv().NotiMode == "Akali" then
                ANotify({
                    ...
                    Kick('[nigger]: Notification Error, please contact emsoftworks if this continues.')
        end
            end
                end
            end
    ...
    if game.PlaceId == 11883610532 or game.PlaceId == 12128125888 or game.PlaceId == 12543953865 then 
        print("[nigger]: Five Duels Detected")
    ...
    Notifications("d-d-daddy~ im cumming!!!!!!!!");
